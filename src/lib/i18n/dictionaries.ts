...
const en: Dict = {
  ...
  "osn.hub.lede":
    "Practice past OSK / OSP / OSN papers like a TKA tryout: one question, Next, then a score.",
  ...
  "osn.archive": "OSN archive",
  "osn.sourceNote": "Official ministry PDFs for extra reading:",
  ...
  "osn.noQuestions": "This paper has no extracted questions yet.",
  "osn.practiceNote":
    "Answer each multiple-choice item, then tap Next. Submit at the end for a score. Essay items are not scored.",
  "osn.practice": "Practice",
  "osn.finished": "Paper complete",
  "osn.finishedLede": "Multiple-choice items count toward your score. Essay items are listed but not scored.",
  "osn.discussion": "Discussion",
  "osn.yourAnswer": "Your answer",
  "osn.soal": "Question",
  "osn.essayHint": "Essay item — write your solution on paper, then tap Next.",
  "osn.finish": "Finish paper",
  "osn.next": "Next question",
  "osn.prev": "Previous",
  "osn.submit": "Submit paper",
  "osn.review": "Review",
  "osn.skipped": "Skipped",
  "osn.essayReview": "Essay · not scored",
  "osn.scoreKeyed": "Score {score}% · {correct}/{total}",
  "osn.scoreAnswered": "Answered {score}% · {correct}/{total} multiple choice",
  ...
  "tka.lessonSaveError": "Could not save this lesson. Check your connection and try again.",
  ...
  "tka.profile.title": "Edit your profile",
  "tka.profile.lede": "Change your name, class, electives, or photo if something is wrong.",
  "tka.profile.save": "Save changes",
  "tka.profile.photo": "Profile picture",
  "tka.profile.photoHint": "A square photo works best. JPEG or PNG.",
  "tka.profile.photoChange": "Upload photo",
  "tka.profile.photoRemove": "Remove photo",
...
const id: Dict = {
  ...
  "osn.hub.lede":
    "Latihan paket OSK / OSP / OSN seperti tryout TKA: satu soal, Soal berikutnya, lalu skor.",
  ...
  "osn.archive": "Arsip OSN",
  "osn.sourceNote": "PDF resmi kementerian untuk bacaan tambahan:",
  ...
  "osn.noQuestions": "Paket ini belum punya soal terurai.",
  "osn.practiceNote":
    "Jawab setiap pilihan ganda, lalu ketuk Soal berikutnya. Kumpulkan di akhir untuk skor. Soal esai tidak dinilai.",
  "osn.practice": "Latihan",
  "osn.finished": "Paket selesai",
  "osn.finishedLede": "Soal pilihan ganda masuk skor. Soal esai tercatat tetapi tidak dinilai.",
  "osn.discussion": "Diskusi",
  "osn.yourAnswer": "Jawabanmu",
  "osn.soal": "Soal",
  "osn.essayHint": "Soal esai — kerjakan di kertas, lalu ketuk Soal berikutnya.",
  "osn.finish": "Selesai paket",
  "osn.next": "Soal berikutnya",
  "osn.prev": "Sebelumnya",
  "osn.submit": "Kumpulkan",
  "osn.review": "Ulasan",
  "osn.skipped": "Dilewati",
  "osn.essayReview": "Esai · tidak dinilai",
  "osn.scoreKeyed": "Skor {score}% · {correct}/{total}",
  "osn.scoreAnswered": "Terjawab {score}% · {correct}/{total} pilihan ganda",
  ...
  "tka.lessonSaveError": "Pelajaran ini belum tersimpan. Cek koneksi, lalu coba lagi.",
  ...
  "tka.profile.title": "Ubah profil",
  "tka.profile.lede": "Perbaiki nama, kelas, mata pelajaran pilihan, atau foto jika ada yang salah.",
  "tka.profile.save": "Simpan perubahan",
  "tka.profile.photo": "Foto profil",
  "tka.profile.photoHint": "Foto persegi paling bagus. JPEG atau PNG.",
  "tka.profile.photoChange": "Unggah foto",
  "tka.profile.photoRemove": "Hapus foto",
